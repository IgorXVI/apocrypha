...
import { bookGetMany, bookGetOne, bookCreateOne, bookUpdateOne, bookDeleteOne } from "~/server/queries"
...
const zodValidationSchema = z.object({
    ...
    isbn10Code: z.string().length(10, { message: "ISBN-10 deve ter exatamente 10 caracteres." }),
    isbn13Code: z.string().length(14, { message: "ISBN-13 deve ter exatamente 14 caracteres." }),
    width: z.number().int().positive({ message: "Largura deve ser um número inteiro positivo." }),
    height: z.number().int().positive({ message: "Altura deve ser um número inteiro positivo." }),
